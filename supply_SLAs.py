...
st.markdown('''This application creates interactive visualizations and returns information related to supply chain SLAs. Uploading a sales report document and a supply chain report document is required for the application to process. Once you upload both documents, processing will begin. Select the full screen button in the top right to view the graphs full screen. Select specific sections of the graph to zoom in and reset axis to return to normal graph view.''')
...
- The graphs are interactive, have fun with the visualizations and experiment to view data in a variety of ways and find the display that works best for you.''')